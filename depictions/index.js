...
$(document).ready(function () {
    ...
    $.getJSON("packages/" + dPackage + ".json", function (data) {
        ...
        if (typeof currentVersion === 'undefined' &&
            ...
            result = "<strong>Compatible with iOS ";
        ...
        for (var v in versions) {
            ...
            changes = data.changelog[version];
        ...
        var extra = {
            "<img class=\"icon\" src=\"icons/twitter.png\"><span>Find me on Github</span>": "https://github.com/pulse0ne",
            "<img class=\"icon\" src=\"icons/email.png\"><span>Send me an email</span>": "mailto:snedigart@gmail.com",
            "<img class=\"icon\" src=\"icons/like.png\"><span>Buy me a &#x1F37A; via <span style=\"font-style:italic;font-weight:bold;\"><span style=\"color:#253b80;\">Pay</span><span style=\"color:#419bd7;\">Pal</strong></span></span>": "https://paypal.me/pulse0ne"
        };
        $.extend(links, extra);
